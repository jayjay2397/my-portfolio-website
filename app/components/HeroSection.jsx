    ...
    return (
        <section>
            <div className="gird grid-cols-1 sm:gird-cols-12">
                ...
                <div>
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-orange-500 to-yellow-500 hover:bg-slate-200 text-white">Contact Me</button>
                    <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-orange-500 to-yellow-500 hover:bg-slate-800 text-white mt-3">
