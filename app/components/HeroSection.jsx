    ...
    return (
        <section>
            <div className="gird grid-cols-1 sm:gird-cols-12">
                ...
                <div>
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-orange-500 to-yellow-500 hover:bg-slate-200 text-white">Hire Me</button>
